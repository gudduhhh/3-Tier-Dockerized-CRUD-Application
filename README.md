...
[![Docker Hub](https://img.shields.io/badge/Docker%20Hub-Published-blue?style=flat-square&logo=docker)](https://hub.docker.com/r/guddu3447/3tier)
...
git clone https://github.com/gudduhhh/3-Tier-Dockerized-CRUD-Application.git
cd 3-Tier-Dockerized-CRUD-Application
...
```
3-Tier-Dockerized-CRUD-Application/
│
...
```dotenv
# ── Docker Hub ──────────────────────────────────────────────
DOCKERHUB_USER=guddu3447          # Your Docker Hub username
...
# 2. Build both images
docker build -t guddu3447/3tier-backend:latest  ./backend
docker build -t guddu3447/3tier-frontend:latest ./frontend

# 3. Push to Docker Hub
docker push guddu3447/3tier-backend:latest
docker push guddu3447/3tier-frontend:latest

# 4. Update .env to point to your images
#    DOCKERHUB_USER=guddu3447
...
All Docker images for this project are available on Docker Hub:

🐳 **Repository:** https://hub.docker.com/r/guddu3447/3tier
...
**Made with ❤️ by Guddu**

*Built as a Docker & DevOps portfolio project by **Guddu**.*
